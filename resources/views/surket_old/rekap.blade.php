					...
					<!-- start: page -->
							...
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ url('/surket-mahasiswa/rekap')}}" method="POST"  role="cari">
			                						{{csrf_field()}}
														<div class="form-group">
													        <div class="col-md-3">
													        	<label>{{__('Cari Berdasarkan Pembuat Surket: *')}}</label>
													        </div>
													        <div class="col-md-4">
													            <input type="text" name="cari" class="form-control{{ $errors->has('cari') ? ' is-invalid' : '' }}" value="{{ old('cari') }}" maxlength="" required="" autofocus="" placeholder=" Masukkan Nama pembuat surket ...">
													            <!-- <select class="form-control mb-md" name="cari" value="" required="">
																	<option value="KRISNA BARATA">KRISNA BARATA</option>
																	<option value="Eep Dimyati, S.IP.">Eep Dimyati, S.IP.</option>
																	<option value="SYAHRUL FAJAR">SYAHRUL FAJAR</option>
																</select> -->
															</div>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Rekapitulasi Surat Keterangan Mahasiswa Berdasarkan Operator</h2>
							</header>
							<div class="panel-body">
								<table class="table table-bordered table-striped table-condensed mb-none">
						        <thead>
						          <tr>
						            <th style="background-color:Silver"><center>Nama Pembuat Surket</center></th>
						            <th style="background-color:Silver"><center>Jumlah Surat diterbitkan</center></th>
						          </tr>
						        </thead>
						        @foreach ($rekap as $b)
									<tbody>
