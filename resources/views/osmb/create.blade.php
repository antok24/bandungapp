					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Input Data Sertifikat OSMB</h2>
							</header>
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ route('osmb.store')}}" method="POST">
			                						{{csrf_field()}}
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" name="program_studi" class="form-control{{ $errors->has('program_studi') ? ' is-invalid' : '' }}" value="{{ old('program_studi') }}" required="">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Import Data Sertifikat OSMB</h2>
							</header>
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ url('/ImportPesertaOsmb') }}" method="post" enctype="multipart/form-data">
							                            @csrf
							                            <div class="form-group">
							                                <h3>Silahkan Import Data Peserta OSMB Disini</h3>
							                                ...
							                                <div>
								                                <div class="col-md-6">
								                                	<a href="{{url('/assets/formatexcel/contoh peserta osmb.xlsx')}}" class="btn btn-success">Download Contoh Excel OSMB</a>
								                                </div>
								                            </div>
							                            </div>
