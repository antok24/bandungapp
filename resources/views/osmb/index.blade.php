					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Edit Data Sertifikat OSMB</h2>
							</header>
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ url('/osmb/search')}}" method="POST"  role="cari">
			                						{{csrf_field()}}
									...
									<tbody>
										<tr>
											...
											<td class="center" width="120px">
												<form action="{{ route('osmb.destroy', $a->nim)}}" method="POST">
												@csrf
												@method('DELETE')
													<a href="/osmb/edit/{{encrypt($a->nim)}}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" data-original-title="Edit data">Edit</a> |
