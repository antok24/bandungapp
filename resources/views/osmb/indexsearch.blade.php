					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Cari Data Sertifikat OSMB</h2>
							</header>
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ url('/SearchOsmbX')}}" method="POST"  role="cari">
			                						{{csrf_field()}}
						...
						<section class="panel">
							<header class="panel-heading">
								...
								@foreach ($result as $a)
								<h2 class="panel-title">Sertifikat OSMB atas nama {{$a->nama}}</h2>
								@endforeach
							</header>
							<div class="panel-body">
						          ...
						          <tr>
									...
									<tbody>
										<tr>
											...
											<td class="center">
													<a class="btn btn-sm btn-warning" target="_blank" href="/osmb/print/{{encrypt($a->nim)}}"><i class="fa fa-print" aria-hidden="true" data-toggle="tooltip" data-placement="top" data-original-title="Print Sertifikat"></i></a>
											</td>
										</tr>
									</tbody>
									@endforeach
