					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Cari Data Sertifikat</h2>
							</header>
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ url('/sertifikat-all/cetak/cari')}}" method="GET"  role="cari">
			                						{{csrf_field()}}
							...
							<div class="panel-body">
						        ...
						        <thead>
						          <tr>
						            ...
						            <th style="background-color:Silver"><center>Nama</center></th>
									...
									<tbody>
										<tr>
											...
											<td class="center">
													<a class="btn btn-sm btn-warning" target="_blank" href="/sertifikat-all/cetak/{{encrypt($a->id)}}"><i class="fa fa-print" aria-hidden="true" data-toggle="tooltip" data-placement="top" data-original-title="Print Sertifikat"></i></a>
											</td>
										</tr>
									</tbody>
									@endforeach
