                    ...
                    <!-- start: page -->
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <thead>
                                  <tr>
                                    <th style="background-color:Tomato"><center><font color="white">TGL Pembuatan</font></center></th>
                                ...
                                @foreach ($result as $a)
                                    <tbody>
                                        <tr>
                                            <td style="background-color:Tomato"><font color="white">{{$a->created_at}}</font></td>
                                            <td>{{$a->no_surat}}</td>
                                            <td>{{$a->nim}}</td>
                                            ...
                                            <td class="center">
                                                    ...
                                                    <a class="btn btn-sm btn-danger" href="/surket-mahasiswa/hapus/{{$a->nim}}"><i class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" data-placement="top" data-original-title="Hapus Surket"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                @endforeach
