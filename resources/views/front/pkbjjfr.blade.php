					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								...
								<span class="text-color-light d-block position-relative font-weight-light">Pelatihan Belajar Jarak Jauh</span>
							</div>
						          ...
						          <tr>
									...
									<tbody>
										<tr>
											...
											<td class="center">
													<a class="btn btn-sm btn-warning" target="_blank" href="/searchnimpkbjj/print/{{encrypt($a->nim)}}"><i class="fa fa-print" aria-hidden="true" data-toggle="tooltip" data-placement="top" data-original-title="Print Sertifikat"></i></a>
											</td>
										</tr>
									</tbody>
									@endforeach
