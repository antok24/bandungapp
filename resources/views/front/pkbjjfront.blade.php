                    ...
                    <!-- start: page -->
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Cari Sertifikat Pelatihan Kegiatan Belajar Jarak Jauh (PKBJJ)</h2>
                            </header>
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                            <section class="panel">
                                                <div class="panel-body">
                                                    <form action="{{ url('/searchnimpkbjj')}}" method="POST"  role="cari">
                                                    {{csrf_field()}}
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                <h2 class="panel-title">Data Peserta Pelatihan Kegiatan Belajar Jarak Jauh UT Bandung</h2>
                            </header>
                            <div class="panel-body">
                                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                <thead>
                                  <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                    <a class="btn btn-sm btn-warning" target="_blank" href="/searchnimpkbjj/print/{{encrypt($a->nim)}}"><i class="fa fa-print" aria-hidden="true" data-toggle="tooltip" data-placement="top" data-original-title="Print Sertifikat"></i> Cetak Sertifikat</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
