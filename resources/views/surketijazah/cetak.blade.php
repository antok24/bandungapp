  ...
  <div class="footer">
   ...
   <div class="content">
    ...
    <table>
        ...
        <tr>
            <td>Lampiran</td><td>: Satu Lembar</td>
        </tr>
        <tr>
    ...
    <br/>
        Memenuhi permohonan klarifikasi/konfirmasi {{$a->nama_instansi}} {{$a->kota_instansi}} untuk kelengkapan berkas kenaikan pangkat tentang ijazah atas nama {{$a->nama_mahasiswa}} yang mengikuti pendidikan pada Universitas Terbuka di Wilayah Kerja UPBJJ-UT Bandung, <br/>dengan ini kami beritahukan dengan hormat bahwa:
        <br/>
    <table class="table2">
        <tr>
        ...
        <tr>
            <td>d.</td><td> Lulusan yang dimaksud merupakan mahasiswa masukan dari {{$a->nama_pendidikan_akhir}}.
            </td>
        </tr>
        <tr>
