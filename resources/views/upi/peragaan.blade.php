							...
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-12">
											<section class="panel">
												<div class="panel-body">
													<form action="{{ url('graduation/upbjj/upi/peragaan/cari')}}" method="POST"  role="cari">
			                						{{csrf_field()}}
							...
							<div class="panel-body">
						        ...
						        <thead>
						          ...
						          <tr>
						          		...
						          		<th width="10px" style="background-color:Silver">Transkrip Nilai</th>
						          		<th width="10px" style="background-color:Silver">Pas Foto</th>
