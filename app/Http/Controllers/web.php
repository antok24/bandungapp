...
Route::get('/', function () {
	...
	Route::get('/bahan-ajar/cekonline/ba','FrontController@indexbahanajar')->name('bahan-ajar.index');
...
Route::middleware('auth')->group(function(){
	...
	Route::group(['prefix'=> 'surket-mahasiswa'], function()
	{
		...
		Route::post('/editx/{no_surat}', 'SurketController@updatex')->name('surket.raga');
		Route::get('/print/{no_surat}', 'SurketController@print');
		Route::get('/hapus/{nim}', 'SurketController@hapus');
	});
